...
;; +-------------------+---+---------------------+---+-----------------+
;; |                   |C-d|delete bookmark      |M-q|query replace    |
;; +-------------------+---+---------------------+---+-----------------+
;; +-------------------------------------------------------------------+
;; |                                M-x                                |
;; +-------------------+-----------------------------------------------+
...
(custom-set-faces
 ...
 '(mode-line ((t (:background "SteelBlue1" :foreground "gray10"))))
 '(mode-line-highlight ((t (:underline t))))
 '(mode-line-inactive ((t (:inherit mode-line :background "grey90" :foreground "grey40" :weight light))))
 '(powerline-active1 ((t (:inherit mode-line :background "SteelBlue1"))))
 '(powerline-active2 ((t (:inherit mode-line :background "DodgerBlue1"))))
